...
./aws-iam-authenticator_0.5.9_windows_amd64.exe add user --userarn="${userarn}" --username=github-action-role --groups=system:masters --kubeconfig="$HOME"/.kube/config --prompt=false
